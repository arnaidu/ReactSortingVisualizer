...
export const formError = {
    ...
    missingFieldErrorMessage: <p className="input-error">*Missing One or More Fields Above</p>,
    arrayTooLongErrorMessage: (
        <p className="input-error">*Array must contain less than or equal to 20 numbers</p>
    ),
    numbersErrorMessage: <p className="input-error">*Can only use numbers between -20 and 20</p>,
};
...
export const ErrorBanner = (props) => {
    ...
    if (errorState && type === "missing-field" && (!existInputArray || !existInputAlgo)) {
    ...
    if (errorState && type === "array" && existInputArray && isValidArray && !properLengthArray) {
